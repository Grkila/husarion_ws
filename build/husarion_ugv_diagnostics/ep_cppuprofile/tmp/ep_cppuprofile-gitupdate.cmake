...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "1.1.1"
  WORKING_DIRECTORY "/husarion_ws/build/husarion_ugv_diagnostics/ep_cppuprofile/src/ep_cppuprofile"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"1.1.1\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/husarion_ws/build/husarion_ugv_diagnostics/ep_cppuprofile/src/ep_cppuprofile'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/husarion_ws/build/husarion_ugv_diagnostics/ep_cppuprofile/src/ep_cppuprofile'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
