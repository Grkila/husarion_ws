...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.0.2"
  WORKING_DIRECTORY "/husarion_ws/build/husarion_ugv_hardware_interfaces/ep_libgpiod/src/ep_libgpiod"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/husarion_ws/build/husarion_ugv_hardware_interfaces/ep_libgpiod/src/ep_libgpiod'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/husarion_ws/build/husarion_ugv_hardware_interfaces/ep_libgpiod/src/ep_libgpiod'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
